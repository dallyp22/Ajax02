-- Scheduled Query: Refresh unit_competitor_pairs table
-- Schedule: Daily at 2:00 AM UTC
-- This query should be configured in Google Cloud Console or via Terraform

-- Query Name: refresh_unit_competitor_pairs
-- Schedule: 0 2 * * * (daily at 2:00 AM UTC)
-- Destination Dataset: rentroll-ai.mart
-- Destination Table: unit_competitor_pairs_temp

-- Step 1: Create temporary table with fresh data
CREATE OR REPLACE TABLE `rentroll-ai.mart.unit_competitor_pairs_temp` 
...
-- Step 2: Atomic swap (to be executed as second query in the schedule)
-- DROP TABLE IF EXISTS `rentroll-ai.mart.unit_competitor_pairs_old`;
-- ALTER TABLE `rentroll-ai.mart.unit_competitor_pairs` RENAME TO unit_competitor_pairs_old;
-- ALTER TABLE `rentroll-ai.mart.unit_competitor_pairs_temp` RENAME TO unit_competitor_pairs;
-- DROP TABLE `rentroll-ai.mart.unit_competitor_pairs_old`; 